...
Серия «Анатомия темы» на этом закончена: гайд — папка, серия — папка гайдов, палитра — файл. Всё показанное — и десяток компонентов, до которых мы не дошли, — собрано на одной странице-полигоне:
